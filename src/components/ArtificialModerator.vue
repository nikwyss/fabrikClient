  ...
  <span>
    <div style="max-width:450px">
      <q-chat-message
        ...
        size=7
        :text="text"
        :sent="alignment=='right' ? false : true"
        ...
        <template v-slot:avatar>
          <div style="z-index: 5">
            ...
            <span
              ...
              @click="tooltip_shuffle"
              :class="tooltip_cursor"
            >
              <img
                :src="avatar"
                aria-hidden="true"
    ...
    <div
      ...
      :style="`text-align:${invAlignment}; padding-${invAlignment}:100px`"
      v-if="!!$slots.actions"
    >
  ...
  computed: {
    ...
    */
    ...
    actor: function () {
      ...
      const allocationShift =
        Math.floor(parseInt(this.randomLocalStorageSeed) + crc) %
        numberOfActors;
    ...
    tooltip: function () {
      ...
      if (this.available_tooltips === null) {
        this.available_tooltips = this.$t(this.tooltip_translation_key, {
      ...
      return this.$i18n.t(
        `${this.tooltip_translation_key}.${this.tooltip_nr}`,
        { actor: this.actorName }
      );
    },
    ...
    tooltip_cursor: function () {
      ...
      let cursor = this.available_tooltips
        ? "cursor-pointer"
        : "no-pointer-events";
      return cursor;
    },
