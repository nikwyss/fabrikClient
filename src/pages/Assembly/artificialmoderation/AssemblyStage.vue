  ...
  >
    ...
    >
      ...
      <template v-slot:actions>
        ...
        <Button
          v-if="$nLength(assembly_scheduled_stages) && !is_stage_last(stage) && !is_stage_scheduled(stage)"
          icon="mdi-arrow-down"
          clickable
          @click="gotoNextStageNr(stage)"
        ...
        <Button
          ...
          v-if="stage && !is_stage_completed(stage) && is_stage_scheduled(stage)"
...
export default {
  ...
  inject: ["gotoStage", "gotoNextStageNr"],
  computed: {
    ongoing: function () {
