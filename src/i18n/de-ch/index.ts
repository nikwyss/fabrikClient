...
export default {
  ...
  assemblies: {
    ...
    home: `Heute sind {maxStages} Punkte auf Ihrer Agenda.`,
    ...
    stage_status_completed: `Bereits beendet`,
    stage_status_not_yet_accessible: 'Gerade noch nicht zugänglich',
    stage_status_disabled: `Deaktiviert`,
    stage_status_deleted: `Gelöscht`,
